...
List<ProductReview> list = new List<ProductReview>()
            ...
            new ProductReview() { ProductID = 15, UserID = 36, Rating = 7.5, Review = "GOOD" },
            new ProductReview() { ProductID = 16, UserID = 37, Rating = 7, Review = "GOOD" },
            new ProductReview() { ProductID = 17, UserID = 38, Rating = 6.8, Review = "AVERAGE" },
            new ProductReview() { ProductID = 18, UserID = 39, Rating = 6.5, Review = "AVERAGE" },
            new ProductReview() { ProductID = 19, UserID = 40, Rating = 6, Review = "AVERAGE" },
            ...
            new ProductReview() { ProductID = 12, UserID = 43, Rating = 4, Review = "BAD" },
            new ProductReview() { ProductID = 13, UserID = 44, Rating = 3, Review = "BAD" },
            new ProductReview() { ProductID = 14, UserID = 45, Rating = 2, Review = "BAD" },
            new ProductReview() { ProductID = 15, UserID = 46, Rating = 7.5, Review = "GOOD" },
};
